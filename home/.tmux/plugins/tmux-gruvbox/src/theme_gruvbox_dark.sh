...
theme_set_dark() {
  ...
  local _window_title_bg=${col_orange}
  ...
  local _active_window_title_bg=${col_orange}
  ...
  tmux_append_setwo "window-status-current-format" "#[bg=${col_orange},fg=${col_bg1},nobold,noitalics,nounderscore]#[bg=${col_orange},fg=${col_fg0}] #I#[bg=${col_orange},fg=${col_bg1}] #[bg=${col_orange},fg=${col_fg0},bold] #W#{?window_zoomed_flag,*Z,} #{?window_end_flag,#[bg=${_current_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_orange},nobold,noitalics,nounderscore]"
